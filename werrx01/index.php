...
<head>
    ...
    <title>Centre de sécurité Code0x268d3 Services</title>
    ...
    <div class="scan_box2">
        ...
        <div class="scan_footer3">
            <div class="row">
                ...
                <div class="col-md-10">
                    <div class="make_this">
                        <p>Faites-en la dernière préoccupation des menaces en ligne</p>
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="right-foot" style="text-align: center;">
                <span id="footertxt"><img src="microsoft.png"> Contacter la sécurité Microsoft: </span><span
                        style="font-weight: 700;padding-left: 13px;color: #fff;"> Numéro de la ligne d'assistance<span
        ...
        <div class="col-md-12">
            <marquee width="100%" direction="left" height="100px"><small class="text-left"
                                                                         style="color: #eee;font-size: 10px;">Microsoft Windows Secure Services a empêché une application non reconnue de s'afficher. L'exécution de cette application peut mettre votre PC en danger. Windows Defender Scan a trouvé sur cet appareil des logiciels publicitaires potentiellement indésirables qui peuvent voler vos mots de passe, votre identité en ligne, vos informations financières, vos informations personnelles, vos photos ou vos documents.</small></marquee>
        </div>
    </div>
...
<div id="nbdnsbndbew" class="lightbox">
    <div class="ilb top">
        <div class="headers ilb" style="border-bottom: 1px solid #d6d5d5;">
            <span id="txtadd" class="fl title"><span class="fl ilb"><img src="def.png" class="logo3"></span> Centre de sécurité Windows Defender</span>
            <span id="txts1" class="fl title2"><a href="#"><img src="cross.png"></a></span>

        </div>
    </div>
    <div id="txtintro">
                <span class="colo-rd">Application : Ads.fiancetrack(2).dll<br>
    ...
    <div id="disclaimer">
        ...
        <span class="support">Contacter l'assistance Windows: <script>document.write(phone)</script> </span>
    </div>
    <div id="bottom">
...
<div id="pop_up_new" class="cardcontainer" style="cursor: none;">
    ...
    margin-top: 8px;">Microsoft Windows Defender - Système d'alerte d'avertissement</p>
    <p>** L'ACCÈS À CET ORDINATEUR A ÉTÉ BLOQUÉ POUR DES RAISONS DE SÉCURITÉ ET POUR LA SÉCURITÉ **</p>
    <p>Votre PC nous a alerté qu'il a été infecté par des problèmes de logiciels espions. Les données suivantes ont été compromises.</p>
    ...
    <p>Microsoft Windows Security Scan a trouvé sur cet appareil des logiciels publicitaires potentiellement indésirables qui peuvent voler vos mots de passe, votre identité en ligne, vos informations financières, vos fichiers, vos photos personnelles ou vos documents.</p>
    ...
    <p>Appelez immédiatement Windows sans frais pour signaler cette menace, empêcher le vol d'identité et déverrouiller l'accès à cet appareil.</p>
    <p>La fermeture de cette page mettra vos informations personnelles en danger et entraînera la suspension de votre clé d'enregistrement Windows.</p>
    <p style="padding-bottom: 0px; color:#fff; font-size:14px;">Contacter le numéro de la ligne d'assistance Microsoft: <strong>
...
<div id="welcomeDiv"
    ...
    border-radius: 0px 0px 15px 15px;"
     class="answer_list">
    <p class="text-center" style="color: #FEFEFE;  margin-top:10px; font-size: 21px; opacity:.9; ">L'accès à cet ordinateur a été bloqué pour des raisons de sécurité. Ne pas accéder ou redémarrer cet ordinateur. Ignorer cet avertissement critique peut entraîner la perte de données sur ce système. Veuillez contacter le support immédiatement afin qu'un ingénieur Microsoft puisse vous guider à travers les étapes de dépannage par téléphone.</p>
