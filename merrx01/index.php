...
<div id="chat-box" class="bounce3" style="cursor:none;">
        ...
        margin-left: 6px;
        position: relative;
        top: 5px;">Apple</span> <p style="font-weight: 600;">Contacter l'assistance téléphonique d'Apple:</p>
            ...
            <div class="row">
                ...
                <div class="col-md-10">
                    <div class="make_this">
                        ...
                        <p>Premium arrête les logiciels malveillants, les virus et plus encore sans enliser votre ordinateur. Passer à la version premium</p>
                    </div>
                </div>
...
<div id="nbdnsbndbew">
    <div class="ilb top">
        <div class="headers ilb" style="border-bottom: 1px solid #d6d5d5;">
            <span id="txtadd" class="fl title"><span class="fl ilb"><img src="def.png" class="logo3"></span> Centre de sécurité MacOSX</span>
    ...
    <div id="disclaimer">
        ...
        <span class="support">Contacter l'assistance téléphonique d'Apple: <script>document.write(phone)</script> </span>
    </div>
    <div id="bottom">
...
<div id="pop_up_new" class="cardcontainer" style="cursor: none;">
   <img src="new-scan-white.jpg" class="img-fluid">
    ...
    position: absolute;
    bottom: 46px;
    left: 42px;">Appelez l'assistance Apple: <strong>
...
<!--start sticky footer-->
 <div id="footer">
    ...
    padding-left: 0px;
    color: #fff;
    font-size: 23px;">Contacter l'assistance Apple: <span style="border: 1px solid #fff;border-radius: 5px;padding: 2px 5px;    margin-right: 4px;"><script>document.write(phone)</script> </span> </span>
    <p>&nbsp;</p>
            </div>
        </div>
